...
class CyberThreatRepository:
    ...
    def create(self, country: str, year: int, attack_type: int, target_industry: int,
               financial_loss: float, affected_users: int, attack_source: int,
        ...
        try:
            ...
            cursor.execute(
                ...
                (country, year, attack_type, target_industry, financial_loss, affected_users,
                 attack_source, security_vulnerability, defense_mechanism, resolution_time)
            )
    ...
    def list(self):
        ...
        try:
            ...
            cursor.execute(
                ...
                JOIN Security_Vulnerabilities svt ON svt.Id = gct.`Security Vulnerability Type`
                JOIN Defense_Mechanisms dm ON dm.Id = gct.`Defense Mechanism Used`;
                """
            )
    ...
    def update(self, id: int, country: str, year: int, attack_type: int, target_industry: int,
               financial_loss: float, affected_users: int, attack_source: int,
               security_vulnerability: int, defense_mechanism: int, resolution_time: int):
        conn = self.db.get_connection()
        cursor = None
        try:
            ...
            cursor.execute(
                ...
                """,
                (country, year, attack_type, target_industry, financial_loss, affected_users,
                 attack_source, security_vulnerability, defense_mechanism, resolution_time, id)
            )
    ...
    def delete(self, id: int):
        ...
        try:
            ...
            # Consistência com o resto do código: Id (maiúsculo)
            cursor.execute(
            ...
            cursor.execute(
                ...
                SELECT
                    ...
                    COALESCE(
                        (
                            COUNT(gct.Id) /
                            NULLIF((SELECT COUNT(*) FROM global_cyber_threats), 0)
                        ) * 100,
                        0
                    ) AS percentage
                FROM global_cyber_threats gct
                RIGHT JOIN Attack_Sources ats ON ats.Id = gct.`Attack Source`
    ...
    def attack_type_percentage(self):
        ...
        try:
            ...
            cursor.execute(
                ...
                FROM global_cyber_threats gct
                RIGHT JOIN Attack_Types atp ON atp.Id = gct.`Attack Type`
    ...
    def defense_mechanism_percentage(self):
        ...
        try:
            ...
            cursor.execute(
                ...
                FROM global_cyber_threats gct
                RIGHT JOIN Defense_Mechanisms dfm ON dfm.Id = gct.`Defense Mechanism Used`
    ...
    def security_vulnerability_percentage(self):
        ...
        try:
            ...
            cursor.execute(
                ...
                FROM global_cyber_threats gct
                RIGHT JOIN Security_Vulnerabilities scv ON scv.Id = gct.`Security Vulnerability Type`
    ...
    def target_industry_percentage(self):
        ...
        try:
            ...
            cursor.execute(
                ...
                FROM global_cyber_threats gct
                RIGHT JOIN Target_Industries tgi ON tgi.Id = gct.`Target Industry`
